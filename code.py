...
combos.combos = [
    ...
    #### Other Chords ####
    Chord((O_CST, KC.I, KC.Y, E_SYM), KC.SPACE),           # Base layer
    ...
    Chord((E_SYM, KC.R),              KC.BSPC),            # Base layer
    Chord((KC.UP, KC.RGHT),           KC.BSPC),            # Nav layer
    Chord((KC.I, KC.R),               KC.DEL),             # Base layer
    Chord((KC.LEFT, KC.UP),           KC.DEL),             # Nav layer
